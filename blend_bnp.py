...
clfs = [
        ...
        #GradientBoostingClassifier(learning_rate=0.05, subsample=0.5, max_depth=20, n_estimators=50)]
...
clf = ExtraTreesClassifier(n_estimators=100, n_jobs=-1, max_depth=50 , max_features = 60 ,  min_samples_leaf=40 , criterion='gini')

clf.fit(dataset_blend_train, y)
y_submission = clf.predict_proba(dataset_blend_test)[:,1]

joblib.dump(clf, './model/' + 'blend_final_2.pkl')
