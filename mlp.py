    ...
    def __init__(self, rng, input, n_in, n_out, W=None, b=None,
        ...
        if W is None:
            ...
            W_values = numpy.asarray(
                    rng.uniform(
                        low=-(numpy.sqrt( ( 60. / (n_in + n_out)) ) ),
                        high=+(numpy.sqrt( ( 60. / (n_in + n_out)) ) ),
                        size=((n_in, n_out))
                    ),
...
def test_mlp(learning_rate=0.13, L1_reg=0.1, L2_reg=0.01, n_epochs=10000,
              batch_size=200, n_hidden=200):
    print("READING DATA")    
