...
with open('./model/neural_net_250_120_50_25_drop.pkl' , 'rb') as pickle_file:
...
pd.DataFrame({"ID": trainId, "PredictedProb": y_pred[:,0] }).to_csv('./ver4/train_net_ds_2_250_120_50_25.csv' , index = False)

print("Saving the response from test set")
y_pred = net.predict(test)
pd.DataFrame({"ID": testId, "PredictedProb": y_pred[:,0] }).to_csv('./ver4/test_net_ds_2_250_120_50_25.csv', index=False)
