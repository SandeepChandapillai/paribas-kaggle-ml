...
blend_est = ExtraTreesClassifier(n_estimators=300, n_jobs=-1, max_depth=100 , max_features = "auto" ,  min_samples_leaf=1 , criterion='gini')

from sklearn.linear_model import LogisticRegression
#blend_est = LogisticRegression(n_jobs = -1)
...
submission.to_csv('blend_ext_100.csv', index=False)
