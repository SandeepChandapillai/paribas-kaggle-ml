...
X_test = test
print('Training...')
extc = ExtraTreesClassifier(n_estimators=1200,max_features= 70,criterion= 'entropy',min_samples_split= 4,
                            max_depth= 60, min_samples_leaf= 1, n_jobs = -1)      
...
pd.DataFrame({"ID": id_test, "PredictedProb": y_pred[:,1]}).to_csv('extra_trees__ka2_1200.csv',index=False)

print("Saving the Model")
from sklearn.externals import joblib
joblib.dump(extc, './model/extraTree__fea_ext_ka2_1200.pkl')
